...
date: 2026-02-20
lastmod: 2026-02-20
ogTitle: "How Accurate Is Apple Watch VO2 Max?"
sitemap:
  priority: 0.8
  changefreq: monthly
faq:
...
related:
  ...
  - title: "Apple Watch Says Cardio Fitness Is Below Average. Now What?"
...
For most users in the typical fitness range, the error is small enough that it does not affect the practical value of the measurement. Your [age-group percentile](/learn/vo2-max-by-age-and-gender/) ranking based on the Apple Watch estimate will usually be correct or very close.
...
**Indoor workouts only.** Apple Watch does not estimate VO2 Max from treadmill runs, cycling, swimming, or gym sessions. If you rarely exercise outdoors, your reading may be stale or based on limited data. Learn more about [how often Apple Watch updates your VO2 Max](/learn/how-often-apple-watch-updates-vo2-max/) and what triggers a new reading.
