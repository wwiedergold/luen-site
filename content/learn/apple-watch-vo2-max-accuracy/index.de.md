...
description: "Wie genau ist die VO2 Max der Apple Watch? Was die Forschung zeigt, wie sie im Vergleich zu Labortests und Garmin abschneidet, und warum Werte falsch sein können."
subtitle: "Was die Forschung sagt, wie sie im Vergleich zu Labortests und Garmin abschneidet, und warum dein Wert daneben liegen könnte."
date: 2026-02-20
lastmod: 2026-02-20
ogTitle: "Wie genau ist die VO2 Max der Apple Watch?"
sitemap:
  priority: 0.8
  changefreq: monthly
faq:
  - question: "Ist die VO2 Max der Apple Watch genau genug, um ihr zu vertrauen?"
    answer: "Für die Verfolgung von Trends über Wochen und Monate ja. Sie ist nicht präzise genug für klinische Diagnosen, zeigt aber zuverlässig, ob sich deine Fitness verbessert, stabil bleibt oder abnimmt. Der Trend ist wertvoller als jede einzelne Messung."
  - question: "Warum zeigt meine Apple Watch eine unterdurchschnittliche VO2 Max, obwohl ich regelmäßig trainiere?"
    answer: "Mehrere Faktoren können das verursachen. Indoor-Workouts zählen nicht für die Schätzung. Abkühlungsspaziergänge nach intensivem Training können künstlich niedrige Werte erzeugen. Und manche Medikamente reduzieren die Herzfrequenzreaktion, was die Berechnung beeinflusst. Versuche einen gezielten Outdoor-Spaziergang im ausgeruhten Zustand für eine genauere Messung."
  - question: "Misst die Apple Watch die VO2 Max beim Radfahren oder Schwimmen?"
    answer: "Nein. Die Apple Watch schätzt die VO2 Max nur bei Outdoor-Geh-, Lauf- oder Wanderworkouts. Radfahren und Schwimmen erzeugen derzeit keine VO2-Max-Werte. Wenn du hauptsächlich diese Aktivitäten machst, erwäge einen gelegentlichen Outdoor-Spaziergang oder -Lauf für eine aktualisierte Schätzung."
related:
  ...
  - title: "Apple Watch sagt Kardio-Fitness ist unterdurchschnittlich. Was nun?"
...
1. **Du startest ein Outdoor-Geh-, Lauf- oder Wanderworkout** (oder die Uhr erkennt eines automatisch).
2. Die Uhr erfasst deine **Herzfrequenz** über den optischen Sensor am Handgelenk.
3. Gleichzeitig nutzt sie **GPS und den Beschleunigungssensor**, um dein Tempo und die Geländesteigung zu bestimmen.
4. Ein Algorithmus berechnet, wie effizient dein Herz-Kreislauf-System bei der gegebenen Belastung arbeitet – und leitet daraus eine **geschätzte VO2 Max** ab.
...
Wenn du deine VO2 Max gezielt verbessern möchtest, lies unseren Leitfaden [Wie du deine VO2 Max verbesserst: Was wirklich funktioniert](/learn/how-to-improve-vo2-max/). Und wenn du wissen willst, wo du im Vergleich zu anderen stehst, nutze unseren [VO2 Max Perzentil-Rechner](/tools/vo2-max-percentile-calculator/).
